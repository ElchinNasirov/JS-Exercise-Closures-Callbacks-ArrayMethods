...
function getFullNames(runners) {
  ...
  newArr.push(`${element.last_name}, ${element.first_name}`
)});
  return newArr;
}
...
function firstNamesAllCaps(runners) {
  /* CODE HERE */
  const upperRunners = runners.map(function(element) {
...
function getRunnersByTShirtSize(runners, tShirtSize) {
  /* CODE HERE */
  const runnersByTShirtSize = runners.filter(function(element){
...
function tallyUpDonations(runners) {
  /* CODE HERE */
  const totalDonations = runners.reduce(function(acc, curVal){
